...
final readonly class ProductPurchase
{
    public function __construct(
        ...
        public GooglePlay\PurchaseState $purchaseState,
        public GooglePlay\ConsumptionState $consumptionState,
        public string $orderId,
        public GooglePlay\PurchaseType $purchaseType,
        public GooglePlay\ProductAcknowledgementState $acknowledgementState,
